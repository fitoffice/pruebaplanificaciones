    ...
    <div className="mt-4">
      ...
      <div className="flex justify-between items-center mb-4 px-1">
        ...
        <div className="flex space-x-2">
          ...
          >
            {showCsvEditor ? 'Ocultar CSV' : 'Mostrar CSV'} {/* Change button text based on state */}
          </button>
      ...
      )} {/* End of conditional rendering for main card */}


      {/* Conditionally render the non-popup CSV editor component */}
      {showCsvEditor && ( // Render only if showCsvEditor is true
        <div className="mt-6"> {/* Add some margin for separation */}
          <PopupEditarRutinaCSV2
            routineData={routine} // Pass the current routine data
            onUpdateRoutine={handleUpdateRoutineFromCsvComponent} // Pass the handler function
          />
        </div>
      )}


      {/* Render other Popups (Always available, visibility controlled by their own state) */}
      ...
      />
      {/* Removed the rendering of PopupEditarRutinaCSV */}
      {/* <PopupEditarRutinaCSV ... /> */}
    </div>
  );
};

// Changed default export to VistaCompleja3
