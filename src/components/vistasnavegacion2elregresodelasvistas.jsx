...
// Renamed component to match the filename
const VistasNavegacion2ElRegresoDeLasVistas = ({ onSelectView }) => {
  ...
  const handleSubViewClick = (viewKey) => {
    ...
    if (onSelectView) { // This check should now work correctly
      ...
      console.warn("onSelectView prop not provided to VistasNavegacion2ElRegresoDeLasVistas"); // Updated warning message
    }
  };
...
// Updated export name
export default VistasNavegacion2ElRegresoDeLasVistas;